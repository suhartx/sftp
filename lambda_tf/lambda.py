...
def lambda_handler(event, context):
    ...
    if persona.__eq__("alumnos"):
        ...
        source_dir2="sftpstoragesuhar/{}".format(source_dir)
    ...
    try:
        ...
        if persona.__eq__("profesor") or tipo.__eq__("lectura")or (tipo.__eq__("escritura")and (nombreFichero.__eq__(""))  or tamanyoSinT==0):
            ...
            print("funtziona")
            s3_resource.Object("sftpstoragesuhar", target_dir).copy_from(
            CopySource=source_dir2)
            print("hasta aqui")
            # Delete the former object A
            s3_resource.Object("sftpstoragesuhar", source_dir).delete()   
